            ...
            setup: self =>
                self.on('key-press-event', (widget, event) => {
                    ...
                    if (
                        checkKeybind(
                            event,
                            userOptions.keybinds.cheatsheet.nextTab
                        )
                    )
                        ...
                        checkKeybind(
                            event,
                            userOptions.keybinds.cheatsheet.prevTab
                        )
                    )
                        ...
                        checkKeybind(
                            event,
                            userOptions.keybinds.cheatsheet.cycleTab
                        )
                    )
                        sheetContents.forEach(tab => tab.cycleTab());
                    // Keybinds
                    if (
                        sheets.attribute.names[sheets.attribute.shown.value] ==
                        'Keybinds'
                    ) {
                        ...
                        if (
                            ...
                            sheetContents.forEach(sheet => {
                                const toSwitchTab =
                                    sheet.attribute.children[
                                        sheet.attribute.shown.value
                                    ];
                                toSwitchTab.nextTab();
                            });
                        } else if (
