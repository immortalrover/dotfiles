...
export default () => {
    const ElementTile = (element) => {
        return Box({
            vertical: true,
            tooltipText: element.electronConfig
                          ...
                          Box({
                              ...
                              children: [
                                  Label({
                                      ...
                                      className:
                                          "cheatsheet-periodictable-elementnum txt-tiny txt-bold",
                                  }),
                                  Box({ hexpand: true }),
                                  Label({
    ...
    const mainBoard = Box({
        ...
        children: periodicTable.map((row, _) =>
            Box({
                // Rows
                className: "spacing-h-5",
    ...
    return Box({
        ...
        children: [mainBoard, seriesBoard, legend],
    });
};
